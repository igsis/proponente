	...
	<div class="container"><?php include 'includes/menu_interno.php'; ?>
		...
		<div class="row">
			...
			<form class="form-horizontal" role="form" action="?perfil=contratos&p=frm_edita_pf&id_pf=<?php echo $ultimo ?>" method="post">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-6"><strong>C.B.O.:</strong> <i><a href="http://www.mtecbo.gov.br/cbosite/pages/pesquisas/BuscaPorTitulo.jsf">Consulte o código aqui</a></i><br/>
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					<form class="form-horizontal" role="form" action="?perfil=frm_arquivos&idPessoa=<?php echo $idPessoaFisica; ?>&tipoPessoa=1" method="post">
						<input type="hidden" name="cadastrarFisica" value="<?php echo $idPessoaFisica ?>" />
						<input type="hidden" name="fisica" value="<?php echo $idPessoaFisica ?>" />		
